...
while True:
    ...
    image[height // 2:, :width // 2] = cv2.circle(small_frame_2,(160, 120),45,(255, 0, 0),-1)
    image[:height // 2, width // 2:] = cv2.line(small_frame_3, (0,0), (320,240), (0, 255, 0), 5)
    image[height // 2:, width // 2:] = cv2.rectangle(small_frame_4,(100, 100),(200, 200),(0, 255, 0),-1)
